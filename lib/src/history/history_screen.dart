...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ProductUpdatedHistoryController historyController = Get.put(ProductUpdatedHistoryController());
    ...
    return Scaffold(
      ...
      body:  ListView.builder(
              itemCount: historyController.history.data?.length,
              itemBuilder: (context, index) {
                HistoryProduct? product = historyController.history.data?[index];
                                  ...
                                  errorWidget: (context, url, error) => Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image:  const DecorationImage(
                                        image: NetworkImage("$baseurlimage/default.png"),
                                        fit: BoxFit.fill,
                                      ),
                                    ),
                                  ),
